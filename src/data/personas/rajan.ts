...
export const rajanPersona: Persona = {
  id: 'rajan',
  name: 'Rajan P.',
  ...
  deviceConnections: [
    ...
    { deviceId: 'mito-app', isActive: true, firstConnected: '2024-10-15', lastRefreshed: '2025-01-11T04:30:00Z' },
  ...
  loads: [
    {
      ...
      status: 'high',
      unit: 'hrs',
      detail: '~6.2 hrs accumulated over 14 days — late bedtimes averaging 11:30 PM',
    },
    {
      id: 'training-load',
      label: 'Training Load',
      ...
      status: 'moderate',
      unit: 'AU',
      detail: 'Volume is optimal but timing (post-8 PM) is disrupting recovery',
    },
    {
      id: 'glycemic-stress',
      ...
      status: 'moderate',
      unit: 'mg/dL',
      detail: 'Fasting glucose crept 95 → 104 over 3 months; sleep debt is a contributing factor',
    },
    {
      id: 'work-stress',
      label: 'Work Stress',
      ...
      status: 'high',
      unit: 'score',
      detail: 'Self-reported 8/10; HRV suppression on weekdays vs weekends confirms physiological load',
    },
    {
      id: 'acr-ratio',
      ...
      status: 'moderate',
      unit: 'ratio',
      detail: 'Ratio 1.15 — within safe zone but approaching overreach threshold at 1.3',
    },
  ],
  tags: ['high-performer', 'sleep-issues', 'zone2-success'],
}

export const rajanInsights: Insight[] = [
  {
    id: 'rajan-insight-001',
    personaId: 'rajan',
    category: 'sleep',
    variableType: 'outcome',  // Sleep efficiency is a daily outcome
    title: 'BEDTIME HOUR → SLEEP EFFICIENCY',
  ...
  {
    id: 'rajan-insight-002',
    personaId: 'rajan',
    category: 'sleep',
    variableType: 'outcome',  // Deep sleep is a daily outcome
    title: 'ZONE 2 MINUTES → DEEP SLEEP',
    ...
    whyNow: 'Your Zone 2 average increased to 45 min—approaching your optimal threshold.',
    holdoutPreview: {
      metric: 'deep_sleep',
      expectedChange: 26,
      unit: 'seconds',
    ...
    showWork: 'On days with Zone 2 training, deep sleep increased by 3.8 seconds per minute trained, up to 52 minutes. Beyond that, returns diminish to +0.2 sec/min. Your optimal is 52 minutes—more provides minimal additional benefit while increasing recovery demands.',
    actionable: true,
    priority: 2,
  },
  {
    id: 'rajan-insight-003',
    personaId: 'rajan',
    category: 'sleep',
    variableType: 'outcome',  // REM sleep is a daily outcome
    title: 'ALCOHOL UNITS → REM SLEEP',
    ...
    whyNow: 'Your REM percentage dropped 4% this week—coinciding with evening drinks.',
    holdoutPreview: {
      metric: 'rem_sleep_pct',
      expectedChange: 4,
      unit: '%',
    ...
    showWork: 'Your alcohol threshold is unusually low at 0.5 drinks—you are alcohol-sensitive. On 89 nights with no alcohol, REM averaged 24%. On 78 nights with 2+ drinks, it dropped to 18%. Even one drink costs you ~2.7% REM.',
    actionable: true,
    priority: 1,
  },
  {
    id: 'rajan-insight-004',
    personaId: 'rajan',
    category: 'recovery',
    variableType: 'outcome',  // Next day HRV is a daily outcome
    title: 'ACUTE:CHRONIC RATIO → NEXT DAY HRV',
    ...
    outcome: {
      metric: 'next_day_hrv',
      effect: '±4.8 ms per 0.1 deviation',
      direction: 'negative',
    },
    certainty: 0.86,
    evidence: {
    ...
    whyNow: 'Your ACR is at 1.08—in the optimal zone. Keep it there.',
    showWork: 'Your HRV peaks when ACR is between 0.9-1.2, with optimal at 1.05. Going above 1.2 (overtraining) costs 4.8 ms per 0.1 increase. Going below 0.9 (undertraining) costs 2.3 ms per 0.1 decrease. The penalty is asymmetric—overtraining hurts more.',
    actionable: true,
    priority: 3,
  },
  {
    id: 'rajan-insight-005',
    personaId: 'rajan',
    category: 'sleep',
    variableType: 'outcome',  // Deep sleep is a daily outcome
    title: 'BEDROOM TEMP → DEEP SLEEP',
    headline: 'Your bedroom temperature has an optimal sweet spot',
    recommendation: 'Set bedroom temperature to 18.5°C (65°F)',
    ...
    causalParams: {
      ...
      theta: {
        ...
        low: 17.7,
        high: 19.3,
        displayValue: '18.5°C (65°F)',
      },
      betaBelow: {
        value: 0.8,
        unit: '%',
        description: '+0.8%/°C (toward optimal)',
      },
      betaAbove: {
        value: -1.2,
        unit: '%',
        description: '-1.2%/°C (too warm)',
      },
      observations: 142,
      completePct: 97.9,
    ...
    outcome: {
      ...
      effect: '-1.2% per °C above optimal',
      direction: 'negative',
    },
    certainty: 0.75,
    evidence: {
    ...
    comparison: {
      before: { value: 15, label: 'At 22°C' },
      after: { value: 19, label: 'At 18.5°C' },
    },
    whyNow: 'Winter heating raised your bedroom to 21.5°C—3°C above your optimal.',
    holdoutPreview: {
      metric: 'deep_sleep_pct',
      expectedChange: 3.6,
      unit: '%',
    ...
    showWork: 'Your deep sleep percentage peaks at 18.5°C. Going warmer costs 1.2% per degree. Going colder costs 0.8% per degree. At your current 21.5°C, you\'re losing ~3.6% deep sleep versus optimal.',
    actionable: true,
    priority: 2,
  },
  {
    id: 'rajan-insight-006',
    personaId: 'rajan',
    category: 'sleep',
    variableType: 'outcome',  // Deep sleep is a daily outcome
    title: 'LAST MEAL HOUR → DEEP SLEEP',
  ...
  },
  {
    ...
    causalParams: {
      ...
      betaBelow: {
        value: -0.15,
        unit: 'CV',
        description: '-0.15 CV/pt (improves toward θ)',
      },
      betaAbove: {
        value: -0.08,
        unit: 'CV',
    ...
    showWork: 'HRV variability (CV) decreases as sleep consistency improves—reaching optimal stability at score 85. Below 85, each point costs 0.15 CV. Your weekend sleep timing is 2+ hours different from weekdays, hurting your score.',
    actionable: true,
    priority: 3,
  },
  // BLOOD BIOMARKER INSIGHTS
  {
    id: 'rajan-insight-008',
    personaId: 'rajan',
    category: 'metabolic',
    variableType: 'marker',  // Fasting glucose is a slow-changing biomarker
    title: 'ZONE 2 MINUTES → FASTING GLUCOSE',
    ...
    whyNow: 'Your Zone 2 has increased to 180 min/week—glucose trending down.',
    holdoutPreview: {
      metric: 'fasting_glucose',
      expectedChange: -4,
      unit: 'mg/dL',
  ...
  },
  {
    ...
    dataSources: ['mito-app', 'bloodwork'],
    comparison: {
  ...
  },
  {
    ...
    whyNow: 'Your sleep average dropped to 6.2 hours—your HbA1c rose 0.2% last quarter.',
    holdoutPreview: {
      metric: 'hba1c',
      expectedChange: -0.08,
      unit: '%',
    ...
    showWork: 'Sleep deprivation impairs glucose regulation. Your data shows a clear threshold at 7 hours—below which HbA1c increases ~0.1% per hour of lost sleep. Getting back to 7 hours could reduce your HbA1c by 0.08% over 3 months.',
    actionable: true,
    priority: 1,
  },
  {
    id: 'rajan-insight-011',
    personaId: 'rajan',
    category: 'metabolic',
    variableType: 'marker',  // hsCRP is a slow-changing inflammation marker
    title: 'OMEGA-3 INTAKE → HSCRP',
...
function generateRajanMetrics(): DailyMetrics[] {
...
export const rajanMetrics: DailyMetrics[] = generateRajanMetrics()

export const rajanLabs: LabResult[] = [
  {
    date: '2024-10-15',
    fastingGlucose: 92,
    hba1c: 5.2,
...
export const rajanProtocols: Protocol[] = [
  {
    id: 'rajan-protocol-sleep',
    personaId: 'rajan',
    ...
    actions: [
      {
        ...
        actionType: 'cutoff',
        time: '10:15 PM',
        linkedInsightId: 'rajan-insight-001',
      },
      {
        id: 'action-caffeine',
      ...
      },
      {
        ...
        actionType: 'cutoff',
        time: '7:30 PM',
        linkedInsightId: 'rajan-insight-006',
      },
      {
        id: 'action-bedroom-temp',
        label: 'Set bedroom to 18.5°C',
        category: 'sleep',
        isActive: false,
        impact: 0.04,
        actionType: 'target',
        linkedInsightId: 'rajan-insight-005',
      },
      {
        id: 'action-alcohol',
        ...
        impact: 0.03,
        actionType: 'target',
        linkedInsightId: 'rajan-insight-003',
      },
      {
        ...
        startTime: '5:00 PM',
        endTime: '6:00 PM',
        linkedInsightId: 'rajan-insight-002',
      },
      {
    ...
    actions: [
      {
        ...
        impact: -6,
        actionType: 'duration',
        linkedInsightId: 'rajan-insight-008',
      },
      {
        ...
        impact: -4,
        actionType: 'duration',
        linkedInsightId: 'rajan-insight-009',
      },
      {
        ...
        impact: -3,
        actionType: 'target',
        linkedInsightId: 'rajan-insight-010',
      },
      {
        ...
        impact: -5,
        actionType: 'duration',
        linkedInsightId: 'rajan-insight-013',
      },
    ],
    states: [
  ...
  {
    id: 'rajan-protocol-inflammation',
    personaId: 'rajan',
    ...
    actions: [
      {
        ...
        impact: -0.5,
        actionType: 'target',
        linkedInsightId: 'rajan-insight-011',
      },
      {
        ...
        impact: -0.2,
        actionType: 'target',
        linkedInsightId: 'rajan-insight-012',
      },
    ],
    states: [],
    triggers: [],
...
export const rajanDailyPlan: DailyPlan = {
  personaId: 'rajan',
  date: new Date().toISOString().split('T')[0],
  greeting: 'Good morning, Rajan. Your HRV was 42ms last night—below your baseline. Let\'s focus on recovery today.',
  priorities: {
    high: [
      {
        id: 'plan-001',
    ...
    moderate: [
      {
        id: 'plan-003',
        text: 'Set bedroom to 19°C tonight',
      ...
      },
      {
        ...
        explanation: 'You\'re on track for 175 min/week—keep it up for lipid benefits',
