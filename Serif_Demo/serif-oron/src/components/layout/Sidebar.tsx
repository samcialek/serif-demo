...
const navItems = [
  { to: '/', icon: Lightbulb, label: 'Insights', exact: true },
  { to: '/data', icon: Database, label: 'Data' },
  { to: '/integration', icon: Link2, label: 'Devices' },
  { to: '/data-value', icon: TrendingUp, label: 'Enhancements' },
      ...
      >
        ...
        <div className="h-24 flex items-center px-5 border-b border-slate-100">
          <NavLink to="/" className="flex items-center gap-3">
            <img
              src="/serif-oron/serif_logo-removebg-preview.png"
              alt="Serif"
                ...
                <li key={item.to}>
                  <NavLink
                    ...
                    className={cn(
                      ...
                      'group flex items-center gap-3 px-4 py-2.5 text-sm font-medium rounded-lg',
                      'transition-all duration-200',
                      isActive
                        ? 'bg-primary-50 text-primary-600 border-l-[3px] border-l-serif-cyan shadow-sm'
        ...
        <div className="px-5 py-4 border-t border-slate-100">
          ...
          <p className="text-[9px] text-slate-300 mt-1 font-mono">v0.9.0-beta</p>
        </div>
      </aside>
    )
  }
