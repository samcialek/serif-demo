      ...
      >
        ...
        {(title || actions) && (
          <div className="mb-8">
            ...
            <div className="h-px bg-gradient-to-r from-slate-200 via-slate-300 to-transparent mt-4" />
          </div>
        )}
...
// Section wrapper - Refined Clinical
  ...
  ({ className, icon, title, description, action, ...props }, ref) => {
    return (
      ...
      >
        ...
        <h3 className="text-lg font-semibold text-slate-700 tracking-tight mb-2">
          {title}
        </h3>
        {description && (
