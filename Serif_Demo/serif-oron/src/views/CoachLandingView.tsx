    ...
    <PageLayout maxWidth="2xl" padding="lg">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-semibold text-slate-800 mb-1">Welcome, Oron</h1>
            <p className="text-slate-500">
              Your health dashboard — <span className="font-medium text-primary-600">{totalInsights} insights</span> available
            </p>
          </div>
          <div className="flex items-center gap-2 px-4 py-2.5 bg-primary-50 border border-primary-100 rounded-xl">
            <Zap className="w-5 h-5 text-primary-500" />
            <span className="text-sm font-medium text-primary-600">Your Health Dashboard</span>
          </div>
        </div>
      </motion.div>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
        <div className="flex items-center gap-3 mb-5">
          ...
          <h2 className="text-lg font-semibold text-slate-800">Health Overview</h2>
        </div>
