...
export const sarahPersona: Persona = {
  ...
  deviceConnections: [
    ...
    { deviceId: 'mito-app', isActive: true, firstConnected: '2024-07-01', lastRefreshed: '2025-01-11T04:30:00Z' },
  ...
  labDraws: 4,
  thresholds: {
    caffeineCutoff: '16:30',      // Different from Rajan - slower metabolizer
...
export const sarahInsights: Insight[] = [
  {
    ...
    title: 'EATING WINDOW → FASTING GLUCOSE',
    ...
    whyNow: 'You\'ve maintained your eating window consistently for 90 days—your glucose is responding.',
    holdoutPreview: {
      metric: 'fasting_glucose',
      expectedChange: -3,
      unit: 'mg/dL',
  ...
  },
  {
    ...
    title: 'POST-MEAL WALKS → GLUCOSE SPIKE',
  ...
  },
  {
    ...
    title: 'CAFFEINE TIMING → SLEEP QUALITY',
    headline: 'Your caffeine cutoff can be later than average',
    recommendation: 'Caffeine is fine until 4:30 PM for you',
    explanation: 'You metabolize caffeine faster—no sleep impact until after 4:30 PM',
    cause: {
  ...
  },
  {
    ...
    title: 'HRV TREND → RECOVERY STATUS',
  ...
  },
  {
    ...
    title: 'SLEEP DURATION → TIME IN RANGE',
  ...
  // BLOOD BIOMARKER INSIGHTS
  {
    ...
    title: 'TIME-RESTRICTED EATING → HBA1C',
    ...
    whyNow: 'Your HbA1c dropped from 5.9% to 5.3%—out of pre-diabetic range.',
    holdoutPreview: {
      metric: 'hba1c',
      expectedChange: -0.1,
      unit: '%',
    ...
    showWork: 'Four consecutive lab draws show steady HbA1c improvement: 5.9% → 5.7% → 5.5% → 5.3%. The 0.6% total reduction correlates perfectly with your consistent 8-hour eating window. Population research supports TRE for glycemic control, but your response is stronger than average.',
    actionable: true,
    priority: 1,
  },
  {
    ...
    title: 'LIFESTYLE CHANGES → TRIGLYCERIDES',
    ...
    dataSources: ['bloodwork', 'mito-app', 'oura'],
    comparison: {
  ...
  },
  {
    ...
    title: 'HDL IMPROVEMENT → CARDIOVASCULAR RISK',
    ...
    whyNow: 'Your HDL crossed the 60 mg/dL threshold—now cardioprotective.',
    holdoutPreview: {
      metric: 'hdl_cholesterol',
      expectedChange: 2,
      unit: 'mg/dL',
  ...
  },
  {
    ...
    title: 'INFLAMMATION REDUCTION → HSCRP',
  ...
  },
  {
    ...
    title: 'VITAMIN D OPTIMIZATION → MULTIPLE MARKERS',
    ...
    dataSources: ['bloodwork', 'mito-app'],
    comparison: {
  ...
  },
  {
    ...
    title: 'LDL REDUCTION → CARDIOVASCULAR RISK',
    ...
    whyNow: 'Your LDL dropped below 100 mg/dL—now in optimal range.',
    holdoutPreview: {
      metric: 'ldl_cholesterol',
      expectedChange: -5,
      unit: 'mg/dL',
    ...
    triggers: [
      {
        ...
        reason: 'Stress hormones elevate glucose—prioritize movement and sleep',
      },
    ],
    simulator: {
      deltas: {
    ...
    triggers: [
      {
        if: ['state-vacation'],
        then: ['action-tre-8hr'],
        reason: 'Maintain eating window even on vacation—it\'s the most impactful',
      },
    ],
    simulator: {
      deltas: {
...
export const sarahDailyPlan: DailyPlan = {
  ...
  greeting: 'Good morning, Sarah! Your time-in-range was 89% yesterday—you\'re crushing it.',
  priorities: {
    high: [
      {
        id: 'plan-001',
